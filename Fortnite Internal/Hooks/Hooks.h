...
namespace Hooks {
    ...
    namespace ClientReturnToMainMenu {
        typedef void(*ClientReturnToMainMenu_t)(void);
        inline ClientReturnToMainMenu_t ClientReturnToMainMenuOriginal = nullptr;

        void __stdcall hkClientReturnToMainMenu();
    }
